...
PRODUCT_COPY_FILES += device/lge/swift/files/init.swift.usb.rc:root/init.swift.usb.rc
...
PRODUCT_COPY_FILES += \
	...
	device/lge/swift/prebuilt/etc/SRSAudioFilter.csv:system/etc/SRSAudioFilter.csv \
...
#        device/lge/swift/proprietary/rzscontrol:system/xbin/rzscontrol \
...
# Flex
PRODUCT_COPY_FILES += \
	device/lge/swift/prebuilt/etc/flex/flex.db:system/etc/flex/flex.db \
	device/lge/swift/prebuilt/etc/flex/flex.xml:system/etc/flex/flex.xml \
...
#	device/lge/swift/proprietary/lib/egl/libGLES_android.so:system/lib/egl/libGLES_android.so \
#	device/lge/swift/proprietary/lib/egl/libGLES_android.so:obj/lib/libGLES_android.so \
